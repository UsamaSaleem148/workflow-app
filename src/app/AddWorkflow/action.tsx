...
interface AnotherComponentProps {
  toggleAddActionModal: (id: WorkFlow | null) => void
  id: string
}

const AddActionDialog = ({ toggleAddActionModal, id }: AnotherComponentProps) => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-gray-800 bg-opacity-50">
      <div className="bg-white p-4 rounded shadow-lg">
        ...
        <button className="bg-blue-500 text-white px-3 py-1 rounded" onClick={handleAddAction}>
          Add
        </button>
